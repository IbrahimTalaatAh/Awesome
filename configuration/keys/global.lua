...
local globalKeys =
  ...
  awful.key(
    ...
    'g',
    function()
      awful.util.spawn_with_shell ('feh --randomize --bg-fill ~/Pictures/wallpapers')
    end,
    {description = 'Change Background', group = 'awesome'}
  ),
  awful.key(
    {modkey},
    'r',
    function()
      awful.spawn ('rofi -show run')--('rofi -combi-modi window,drun -show combi -modi combi')
    end,
  ...
  awful.key(
    ...
    'space',
    function()
      awful.spawn('rofi -show run')-- -combi-modi window,drun -show combi -modi combi')
    end,
